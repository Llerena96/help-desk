...
export function Sidebar({ isSidebarOpen, setSidebarOpen }) {
  ...
  return (
    <>
      ...
      <aside
        className={`relative h-screen ${isSidebarOpen ? "w-64" : "w-20"
      ...
      <div className="flex items-center justify-center mb-6">
        <h1
          className={`text-center text-xl font-bold transition-all pt-2 pl-1 ${isSidebarOpen ? "opacity-100" : "opacity-0 hidden"} `}
        >
          Mesa de Ayuda
        </h1>
      </div>
